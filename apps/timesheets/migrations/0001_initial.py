...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['employee', 'week_start'], name='weekly_time_employe_659205_idx'),
        ),
        migrations.AddIndex(
            model_name='weeklytimesheet',
            index=models.Index(fields=['status', 'week_start'], name='weekly_time_status_375d2f_idx'),
        ),
