...
class MeetingListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Meeting
        fields = [
            "id", "title", "priority", "priority_label",
    ...
    def get_can_transition(self, obj):
        ...
        if "pmt.crm.meeting.view_all" in user_perms:
            return True
        uid = user.pk
        return (
...
class MeetingDetailSerializer(MeetingListSerializer):
    ...
    class Meta(MeetingListSerializer.Meta):
        fields = MeetingListSerializer.Meta.fields + ["available_states"]
...
class MeetingTransitionSerializer(serializers.Serializer):
