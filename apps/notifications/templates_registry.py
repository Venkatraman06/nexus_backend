...
DEFAULT_TEMPLATES = [
    ...
    {
        "event_type": EventType.MEETING_DUE_TODAY,
        "title_template": "Due Today: {title}",
        "message_template": "Your Meeting is scheduled for today{time_suffix}.",
        "severity": NotificationSeverity.WARNING,
        "default_action_url": "/workspace/meetings?view=calendar",
    },
    {
        "event_type": EventType.MEETING_OVERDUE,
        "title_template": "Overdue: {title}",
        "message_template": "This Meeting was due {days_overdue} day(s) ago.",
        "severity": NotificationSeverity.URGENT,
        "default_action_url": "/workspace/meetings",
    },
    {
        "event_type": EventType.MEETING_ASSIGNED,
        "title_template": "New Meeting: {title}",
        "message_template": "You have been assigned to this meeting.",
        "severity": NotificationSeverity.INFO,
        "default_action_url": "/workspace/meetings?id={reference_id}",
    },
    {
        "event_type": EventType.MEETING_COMMENTED,
        "title_template": "New Comment: {title}",
        "message_template": "{actor_name} commented on meeting \"{title}\".",
        "severity": NotificationSeverity.INFO,
        "default_action_url": "/workspace/meetings?id={reference_id}",
    },
    {
        "event_type": EventType.MEETING_UPDATED,
        "title_template": "Meeting Updated: {title}",
        "message_template": "{actor_name} updated meeting \"{title}\".",
        "severity": NotificationSeverity.INFO,
        "default_action_url": "/workspace/meetings?id={reference_id}",
    },
    {
