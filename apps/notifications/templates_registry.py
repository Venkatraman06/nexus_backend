...
DEFAULT_TEMPLATES = [
    ...
    },
    {
        ...
        "title_template": "Due Today: {title}",
        "message_template": "Your {type_label} is scheduled for today{time_suffix}.",
        "severity": NotificationSeverity.WARNING,
    ...
    },
    {
        ...
        "message_template": "This {type_label} was due {days_overdue} day(s) ago.",
        "severity": NotificationSeverity.URGENT,
        "default_action_url": "/workspace/followups",
    },
    {
        ...
        "severity": NotificationSeverity.INFO,
        "default_action_url": "/workspace/followups?id={reference_id}",
    },
    {
    ...
    },
    {
        ...
        "title_template": "Task Update: {title}",
        "message_template": "{actor_name} moved this to {status}.",
        "severity": NotificationSeverity.INFO,
        "default_action_url": "/workspace/todos",
    },
    {
